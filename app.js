...
const myAcc = new PersonAccount("Abdul", "Basit", [], []);

myAcc.addIncome(20000, "Development");
myAcc.addExpense(5000, "Travelling");
console.log(myAcc)
...
let car = new Automobile('car', 'Audi', '2020', 'Black', '250km/hr');
...
let bus  = new Automobile('Bus', 'Coaster', '2020', 'golden', '130km/hr');
let truck = new Automobile('truck', 'tanker', '2022', 'gray', '130km/hr');
